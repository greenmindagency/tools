...
'pagecontent3' => 'a 2 columns section at the left a 6 words title and 10-15 words subtitle, with a full content it can accept a pagraph and a bullet points below it or a full of content total 50 words max, at the right an image please suggest some keywords to search in the stock websites',
'pagecontent4' => 'Team/feature loop in two columns: image left of each team member, and in right name of the team member, below it is the title, then 1–2 short paragraphs about the team member, at the end of the team members look you can add something like Message From .. or anything else related to the team, it optional to have the end description based on content',
