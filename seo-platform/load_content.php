...
try {
    ...
    $stmt = $pdo->prepare('SELECT post_date, title, cluster, content_type AS type, doc_link, status, comments FROM client_content WHERE client_id = ? AND post_date BETWEEN ? AND ? ORDER BY post_date');
