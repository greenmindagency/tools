...
function copyPrompt(btn){
  ...
  const text = `please make a table for occassions days for ${clientName} in ${country} for the ${year} and make the table start with the date and the next column in the occassion name Please use the format for the date like this ${year}-01-01\n\nplease also include relgions muslimes occassions and of course the bank holidays occassions and days related to the country for festival,you have to search online to get the correct date before give it to me, please follow the below alwayes: date | occasion`;
